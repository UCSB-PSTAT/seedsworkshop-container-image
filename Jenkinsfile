            ...
            stages{
                ...
                stage('Test') {
                    steps {
                        ...
                        sh 'podman run -it --rm --pull=never localhost/$IMAGE_NAME R -e "library(\"corrplot\");library(\"dplyr\");library(\"caret\");library(\"e1071\");library(\"gbm\");library(\"ggplot2\");library(\"lubridate\");library(\"MASS\");library(\"psych\");library(\"randomForest\");library(\"RColorBrewer\");library(\"reshape2\");library(\"ROC\");library(\"rpart\");library(\"scales\");library(\"tidyr\")"'
